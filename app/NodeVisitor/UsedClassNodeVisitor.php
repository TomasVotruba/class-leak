...
use ClassLeak202311\PhpParser\Node;
use ClassLeak202311\PhpParser\Node\Expr\ConstFetch;
use ClassLeak202311\PhpParser\Node\Expr\FuncCall;
use ClassLeak202311\PhpParser\Node\Name;
use ClassLeak202311\PhpParser\Node\Stmt;
use ClassLeak202311\PhpParser\Node\Stmt\ClassMethod;
use ClassLeak202311\PhpParser\Node\Stmt\Namespace_;
use ClassLeak202311\PhpParser\NodeTraverser;
use ClassLeak202311\PhpParser\NodeVisitorAbstract;
