...
use ClassLeak202402\PhpParser\Comment\Doc;
use ClassLeak202402\PhpParser\Node;
use ClassLeak202402\PhpParser\Node\Identifier;
use ClassLeak202402\PhpParser\Node\Name;
use ClassLeak202402\PhpParser\Node\Stmt\Class_;
use ClassLeak202402\PhpParser\Node\Stmt\ClassLike;
use ClassLeak202402\PhpParser\Node\Stmt\Interface_;
use ClassLeak202402\PhpParser\NodeTraverser;
use ClassLeak202402\PhpParser\NodeVisitorAbstract;
