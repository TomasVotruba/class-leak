...
use ClassLeak202406\PhpParser\Comment\Doc;
use ClassLeak202406\PhpParser\Node;
use ClassLeak202406\PhpParser\Node\Identifier;
use ClassLeak202406\PhpParser\Node\Name;
use ClassLeak202406\PhpParser\Node\Stmt\Class_;
use ClassLeak202406\PhpParser\Node\Stmt\ClassLike;
use ClassLeak202406\PhpParser\Node\Stmt\Interface_;
use ClassLeak202406\PhpParser\NodeTraverser;
use ClassLeak202406\PhpParser\NodeVisitorAbstract;
