...
use ClassLeak202504\PhpParser\Comment\Doc;
...
use ClassLeak202504\PhpParser\Node\Stmt\ClassLike;
use ClassLeak202504\PhpParser\Node\Stmt\Interface_;
use ClassLeak202504\PhpParser\NodeTraverser;
use ClassLeak202504\PhpParser\NodeVisitorAbstract;
