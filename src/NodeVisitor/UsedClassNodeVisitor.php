...
use ClassLeak202404\PhpParser\Node\Expr\ConstFetch;
use ClassLeak202404\PhpParser\Node\Expr\FuncCall;
use ClassLeak202404\PhpParser\Node\Name;
use ClassLeak202404\PhpParser\Node\Stmt;
use ClassLeak202404\PhpParser\Node\Stmt\ClassMethod;
use ClassLeak202404\PhpParser\Node\Stmt\Namespace_;
use ClassLeak202404\PhpParser\NodeTraverser;
use ClassLeak202404\PhpParser\NodeVisitorAbstract;
