...
use ClassLeak202605\Nette\Utils\FileSystem;
...
final class FileWithClass implements JsonSerializable
{
    ...
    {
        $fileContents = FileSystem::read($this->filePath);
        if (\strpos($fileContents, 'ClassLeak202605\\Doctrine\\ODM\\MongoDB\\Mapping\\Annotations') !== \false) {
            return \true;
        }
        if (\strpos($fileContents, 'ClassLeak202605\\Doctrine\\ORM\\Annotations') !== \false) {
            return \true;
        }
