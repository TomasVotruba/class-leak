...
use ClassLeak202501\Nette\Utils\FileSystem;
...
final class FileWithClass implements JsonSerializable
{
    ...
    {
        $fileContents = FileSystem::read($this->filePath);
        if (\strpos($fileContents, 'ClassLeak202501\\Doctrine\\ODM\\MongoDB\\Mapping\\Annotations') !== \false) {
            return \true;
        }
        if (\strpos($fileContents, 'ClassLeak202501\\Doctrine\\ORM\\Annotations') !== \false) {
            return \true;
        }
