...
final class CheckCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $usedNames = $this->resolveUsedClassNames($phpFilePaths, function () use($isJson, $findingClassesProgressBar) : void {
            if ($isJson) {
                return;
            }
        ...
        $possiblyUnusedFilesWithClasses = $this->possiblyUnusedClassesFilter->filter($existingFilesWithClasses, $usedNames, $typesToSkip, $suffixesToSkip, $attributesToSkip, $shouldIncludeEntities, $analysisProgressBar);
