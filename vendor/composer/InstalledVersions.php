 ...
 */
namespace ClassLeak202307\Composer;

use ClassLeak202307\Composer\Autoload\ClassLoader;
use ClassLeak202307\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202307\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
