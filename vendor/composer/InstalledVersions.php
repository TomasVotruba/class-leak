 ...
 */
namespace ClassLeak202410\Composer;

use ClassLeak202410\Composer\Autoload\ClassLoader;
use ClassLeak202410\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202410\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
