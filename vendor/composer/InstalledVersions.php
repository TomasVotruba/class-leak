 ...
 */
namespace ClassLeak202402\Composer;

use ClassLeak202402\Composer\Autoload\ClassLoader;
use ClassLeak202402\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202402\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
