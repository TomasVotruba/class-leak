 ...
 */
namespace ClassLeak202406\Composer;

use ClassLeak202406\Composer\Autoload\ClassLoader;
use ClassLeak202406\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202406\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
