 ...
 */
namespace ClassLeak202308\Composer;

use ClassLeak202308\Composer\Autoload\ClassLoader;
use ClassLeak202308\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202308\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
