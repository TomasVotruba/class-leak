 ...
 */
namespace ClassLeak202403\Composer;

use ClassLeak202403\Composer\Autoload\ClassLoader;
use ClassLeak202403\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202403\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
