 ...
 */
namespace ClassLeak202412\Composer;

use ClassLeak202412\Composer\Autoload\ClassLoader;
use ClassLeak202412\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202412\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
