 ...
 */
namespace ClassLeak202605\Composer;

use ClassLeak202605\Composer\Autoload\ClassLoader;
use ClassLeak202605\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202605\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
