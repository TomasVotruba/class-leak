 ...
 */
namespace ClassLeak202310\Composer;

use ClassLeak202310\Composer\Autoload\ClassLoader;
use ClassLeak202310\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202310\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
