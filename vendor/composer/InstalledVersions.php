 ...
 */
namespace ClassLeak202404\Composer;

use ClassLeak202404\Composer\Autoload\ClassLoader;
use ClassLeak202404\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202404\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
