 ...
 */
namespace ClassLeak202504\Composer;

use ClassLeak202504\Composer\Autoload\ClassLoader;
use ClassLeak202504\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202504\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
