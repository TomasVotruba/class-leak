 ...
 */
namespace ClassLeak202501\Composer;

use ClassLeak202501\Composer\Autoload\ClassLoader;
use ClassLeak202501\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202501\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
