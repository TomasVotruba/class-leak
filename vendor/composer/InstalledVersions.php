 ...
 */
namespace ClassLeak202511\Composer;

use ClassLeak202511\Composer\Autoload\ClassLoader;
use ClassLeak202511\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202511\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
