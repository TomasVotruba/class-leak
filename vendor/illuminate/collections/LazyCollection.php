...
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    ...
    public function chunk($size, $preserveKeys = \true)
    {
        ...
        switch ($preserveKeys) {
            case \true:
                $add = function (array &$chunk, Traversable $iterator) {
                    return $chunk[$iterator->key()] = $iterator->current();
                };
                break;
            case \false:
                $add = function (array &$chunk, Traversable $iterator) {
                    return $chunk[] = $iterator->current();
                };
                break;
        }
     ...
     */
    public function withHeartbeat($interval, callable $callback)
    {
