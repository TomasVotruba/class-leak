...
use ArrayAccess;
use Closure;
use ClassLeak202605\Illuminate\Contracts\Support\Arrayable;
use ClassLeak202605\Illuminate\Contracts\Support\Jsonable;
use ClassLeak202605\Illuminate\Support\Traits\Macroable;
...
class Arr
{
     ...
     */
    public static function array($array, $key, ?array $default = null) : array
    {
     ...
     * @param string|int|null $key
     */
    public static function boolean($array, $key, ?bool $default = null) : bool
    {
        $value = Arr::get($array, $key, $default);
        if (!\is_bool($value)) {
    ...
    public static function last($array, ?callable $callback = null, $default = null)
    {
        if (\is_null($callback)) {
            \end($array);
            return empty($array) ? value($default) : $array[\key($array)];
        }
     ...
     * @param string|int|null $key
     */
    public static function float($array, $key, ?float $default = null) : float
    {
        $value = Arr::get($array, $key, $default);
        if (!\is_float($value)) {
    ...
    public static function from($items)
    {
        switch (\true) {
            case \is_array($items):
                return $items;
            case $items instanceof Enumerable:
                return $items->all();
            case $items instanceof Arrayable:
                return $items->toArray();
            case $items instanceof WeakMap:
     ...
     * @param string|int|null $key
     */
    public static function integer($array, $key, ?int $default = null) : int
    {
        $value = Arr::get($array, $key, $default);
        if (!\is_int($value)) {
    ...
    public static function isAssoc(array $array)
    {
        ...
        return !$arrayIsListFunction($array);
    }
    /**
     ...
     * @return array
     */
    public static function push(&$array, $key, ...$values) : array
    {
     ...
     * @param string|int|null $key
     */
    public static function string($array, $key, ?string $default = null) : string
    {
        $value = Arr::get($array, $key, $default);
        if (!\is_string($value)) {
    ...
    {
        return \array_filter($array, $callback === null ? function ($value, $key) : bool {
            return !empty($value);
        } : $callback, $callback === null ? \ARRAY_FILTER_USE_BOTH : \ARRAY_FILTER_USE_BOTH);
    }
    /**
