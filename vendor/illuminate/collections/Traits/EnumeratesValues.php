...
use ClassLeak202605\Illuminate\Support\Enumerable;
use ClassLeak202605\Illuminate\Support\HigherOrderCollectionProxy;
use JsonSerializable;
use UnexpectedValueException;
use UnitEnum;
use function ClassLeak202605\Illuminate\Support\enum_value;
/**
...
trait EnumeratesValues
{
    ...
    public function mapToGroups(callable $callback)
    {
        ...
        return $groups->map(\Closure::fromCallable([$this, 'make']));
    }
    /**
    ...
    {
        return (new Collection($callbacks))->reduce(function ($carry, $callback) {
