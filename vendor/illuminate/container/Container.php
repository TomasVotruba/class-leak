...
use Closure;
use Exception;
use ClassLeak202605\Illuminate\Container\Attributes\Bind;
use ClassLeak202605\Illuminate\Container\Attributes\Scoped;
use ClassLeak202605\Illuminate\Container\Attributes\Singleton;
use ClassLeak202605\Illuminate\Contracts\Container\BindingResolutionException;
use ClassLeak202605\Illuminate\Contracts\Container\CircularDependencyException;
use ClassLeak202605\Illuminate\Contracts\Container\Container as ContainerContract;
use ClassLeak202605\Illuminate\Contracts\Container\ContextualAttribute;
use ClassLeak202605\Illuminate\Contracts\Container\SelfBuilding;
use ClassLeak202605\Illuminate\Support\Traits\ReflectsClosures;
use LogicException;
...
class Container implements ArrayAccess, ContainerContract
{
    ...
    public function build($concrete)
    {
        ...
        $this->fireAfterResolvingAttributeCallbacks(\method_exists($reflector, 'getAttributes') ? $reflector->getAttributes() : [], $instance = new $concrete(...$instances));
        return $instance;
    }
    /**
    ...
    protected function resolveDependencies(array $dependencies)
    {
        ...
        foreach ($dependencies as $dependency) {
            ...
            $result = $result ?? \is_null($className = Util::getParameterClassName($dependency)) ? $this->resolvePrimitive($dependency) : $this->resolveClass($dependency, $className);
    ...
    {
        $className = $className ?? Util::getParameterClassName($parameter);
