...
use ClassLeak202307\PhpParser\Parser\Tokens;
class Lexer
{
    protected $code;
    protected $tokens;
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('ClassLeak202307\\T_ONUMBER')) {
            $tokenMap[\ClassLeak202307\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('ClassLeak202307\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\ClassLeak202307\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
