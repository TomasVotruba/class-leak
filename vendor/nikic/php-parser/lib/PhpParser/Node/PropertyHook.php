...
namespace ClassLeak202605\PhpParser\Node;

use ClassLeak202605\PhpParser\Modifiers;
use ClassLeak202605\PhpParser\Node\Expr\Assign;
use ClassLeak202605\PhpParser\Node\Expr\PropertyFetch;
use ClassLeak202605\PhpParser\Node\Expr\Variable;
use ClassLeak202605\PhpParser\Node\Stmt\Expression;
use ClassLeak202605\PhpParser\Node\Stmt\Return_;
use ClassLeak202605\PhpParser\NodeAbstract;
