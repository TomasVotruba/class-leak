...
namespace ClassLeak202501\PhpParser\Node;

use ClassLeak202501\PhpParser\Modifiers;
use ClassLeak202501\PhpParser\Node\Expr\Assign;
use ClassLeak202501\PhpParser\Node\Expr\PropertyFetch;
use ClassLeak202501\PhpParser\Node\Expr\Variable;
use ClassLeak202501\PhpParser\Node\Stmt\Expression;
use ClassLeak202501\PhpParser\Node\Stmt\Return_;
use ClassLeak202501\PhpParser\NodeAbstract;
