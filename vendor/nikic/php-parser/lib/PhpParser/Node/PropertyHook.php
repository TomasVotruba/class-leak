...
namespace ClassLeak202511\PhpParser\Node;

use ClassLeak202511\PhpParser\Modifiers;
use ClassLeak202511\PhpParser\Node\Expr\Assign;
use ClassLeak202511\PhpParser\Node\Expr\PropertyFetch;
use ClassLeak202511\PhpParser\Node\Expr\Variable;
use ClassLeak202511\PhpParser\Node\Stmt\Expression;
use ClassLeak202511\PhpParser\Node\Stmt\Return_;
use ClassLeak202511\PhpParser\NodeAbstract;
