...
namespace ClassLeak202504\PhpParser\Node;

use ClassLeak202504\PhpParser\Modifiers;
use ClassLeak202504\PhpParser\Node\Expr\Assign;
use ClassLeak202504\PhpParser\Node\Expr\PropertyFetch;
use ClassLeak202504\PhpParser\Node\Expr\Variable;
use ClassLeak202504\PhpParser\Node\Stmt\Expression;
use ClassLeak202504\PhpParser\Node\Stmt\Return_;
use ClassLeak202504\PhpParser\NodeAbstract;
