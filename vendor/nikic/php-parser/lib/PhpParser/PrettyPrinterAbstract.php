...
use ClassLeak202511\PhpParser\Internal\DiffElem;
use ClassLeak202511\PhpParser\Internal\Differ;
use ClassLeak202511\PhpParser\Internal\PrintableNewAnonClassNode;
use ClassLeak202511\PhpParser\Internal\TokenStream;
use ClassLeak202511\PhpParser\Node\AttributeGroup;
use ClassLeak202511\PhpParser\Node\Expr;
use ClassLeak202511\PhpParser\Node\Expr\AssignOp;
use ClassLeak202511\PhpParser\Node\Expr\BinaryOp;
use ClassLeak202511\PhpParser\Node\Expr\Cast;
use ClassLeak202511\PhpParser\Node\IntersectionType;
use ClassLeak202511\PhpParser\Node\MatchArm;
use ClassLeak202511\PhpParser\Node\Param;
use ClassLeak202511\PhpParser\Node\PropertyHook;
use ClassLeak202511\PhpParser\Node\Scalar;
use ClassLeak202511\PhpParser\Node\Stmt;
use ClassLeak202511\PhpParser\Node\UnionType;
