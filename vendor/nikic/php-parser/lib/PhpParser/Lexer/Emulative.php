...
namespace ClassLeak202411\PhpParser\Lexer;

use ClassLeak202411\PhpParser\Error;
use ClassLeak202411\PhpParser\ErrorHandler;
use ClassLeak202411\PhpParser\Lexer;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202411\PhpParser\Lexer\TokenEmulator\TokenEmulator;
