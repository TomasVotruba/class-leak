...
namespace ClassLeak202406\PhpParser\Lexer;

use ClassLeak202406\PhpParser\Error;
use ClassLeak202406\PhpParser\ErrorHandler;
use ClassLeak202406\PhpParser\Lexer;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202406\PhpParser\Lexer\TokenEmulator\TokenEmulator;
