...
namespace ClassLeak202605\PhpParser\Lexer;

use ClassLeak202605\PhpParser\Error;
use ClassLeak202605\PhpParser\ErrorHandler;
use ClassLeak202605\PhpParser\Lexer;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ClassLeak202605\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use ClassLeak202605\PhpParser\PhpVersion;
use ClassLeak202605\PhpParser\Token;
