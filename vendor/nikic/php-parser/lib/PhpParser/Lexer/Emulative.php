...
namespace ClassLeak202504\PhpParser\Lexer;

use ClassLeak202504\PhpParser\Error;
use ClassLeak202504\PhpParser\ErrorHandler;
use ClassLeak202504\PhpParser\Lexer;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202504\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ClassLeak202504\PhpParser\PhpVersion;
use ClassLeak202504\PhpParser\Token;
