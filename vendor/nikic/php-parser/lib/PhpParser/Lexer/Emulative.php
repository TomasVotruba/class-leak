...
namespace ClassLeak202412\PhpParser\Lexer;

use ClassLeak202412\PhpParser\Error;
use ClassLeak202412\PhpParser\ErrorHandler;
use ClassLeak202412\PhpParser\Lexer;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202412\PhpParser\Lexer\TokenEmulator\TokenEmulator;
