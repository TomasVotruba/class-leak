...
namespace ClassLeak202511\PhpParser\Lexer;

use ClassLeak202511\PhpParser\Error;
use ClassLeak202511\PhpParser\ErrorHandler;
use ClassLeak202511\PhpParser\Lexer;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ClassLeak202511\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use ClassLeak202511\PhpParser\PhpVersion;
use ClassLeak202511\PhpParser\Token;
