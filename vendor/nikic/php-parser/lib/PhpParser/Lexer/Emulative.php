...
namespace ClassLeak202501\PhpParser\Lexer;

use ClassLeak202501\PhpParser\Error;
use ClassLeak202501\PhpParser\ErrorHandler;
use ClassLeak202501\PhpParser\Lexer;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202501\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ClassLeak202501\PhpParser\PhpVersion;
use ClassLeak202501\PhpParser\Token;
