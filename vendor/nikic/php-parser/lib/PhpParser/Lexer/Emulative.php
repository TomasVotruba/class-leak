...
namespace ClassLeak202403\PhpParser\Lexer;

use ClassLeak202403\PhpParser\Error;
use ClassLeak202403\PhpParser\ErrorHandler;
use ClassLeak202403\PhpParser\Lexer;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202403\PhpParser\Lexer\TokenEmulator\TokenEmulator;
