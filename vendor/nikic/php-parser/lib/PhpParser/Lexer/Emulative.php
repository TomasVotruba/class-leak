...
namespace ClassLeak202404\PhpParser\Lexer;

use ClassLeak202404\PhpParser\Error;
use ClassLeak202404\PhpParser\ErrorHandler;
use ClassLeak202404\PhpParser\Lexer;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202404\PhpParser\Lexer\TokenEmulator\TokenEmulator;
