...
if (!\function_exists('ClassLeak202605\\get_error_handler')) {
    function get_error_handler() : ?callable
    {
        return p\Php85::get_error_handler();
    }
}
if (!\function_exists('ClassLeak202605\\get_exception_handler')) {
    function get_exception_handler() : ?callable
    {
        return p\Php85::get_exception_handler();
    }
}
if (!\function_exists('ClassLeak202605\\array_first')) {
    function array_first(array $array)
    {
        return p\Php85::array_first($array);
    }
}
if (!\function_exists('ClassLeak202605\\array_last')) {
    function array_last(array $array)
    {
        return p\Php85::array_last($array);
    }
}
if (\extension_loaded('intl') && !\function_exists('ClassLeak202605\\locale_is_right_to_left')) {
...
if (\extension_loaded('intl') && !\function_exists('ClassLeak202605\\grapheme_levenshtein')) {
