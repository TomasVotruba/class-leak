...
class Command
{
     ...
     * @param mixed $default
     */
    public function addArgument(string $name, int $mode = null, string $description = '', $default = null /* array|\Closure $suggestedValues = null */)
    {
     ...
     * @param mixed $default
     */
    public function addOption(string $name, $shortcut = null, int $mode = null, string $description = '', $default = null /* array|\Closure $suggestedValues = [] */)
    {
