 ...
 */
namespace ClassLeak202308\Symfony\Component\Console\Command;

use ClassLeak202308\Symfony\Component\Console\Application;
use ClassLeak202308\Symfony\Component\Console\Attribute\AsCommand;
...
use ClassLeak202308\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('ClassLeak202308\\setproctitle')) {
