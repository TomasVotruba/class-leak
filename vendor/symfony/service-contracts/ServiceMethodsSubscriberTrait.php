 ...
 */
namespace ClassLeak202605\Symfony\Contracts\Service;

use ClassLeak202605\Psr\Container\ContainerInterface;
use ClassLeak202605\Symfony\Contracts\Service\Attribute\Required;
use ClassLeak202605\Symfony\Contracts\Service\Attribute\SubscribedService;
/**
    ...
    public static function getSubscribedServices() : array
    {
        ...
        foreach ($reflectors as $reflector) {
            ...
            if ($reflector instanceof \ReflectionMethod) {
                ...
                if (\PHP_VERSION_ID < 80400 || !$reflector->hasHook(\ClassLeak202605\PropertyHookType::Get)) {
