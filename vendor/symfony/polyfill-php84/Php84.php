...
final class Php84
{
    ...
    public static function bcceil(string $num) : string
    {
        ...
        return self::bcround($num, 0, \ClassLeak202605\RoundingMode::PositiveInfinity);
    }
    ...
    public static function bcfloor(string $num) : string
    {
        ...
        return self::bcround($num, 0, \ClassLeak202605\RoundingMode::NegativeInfinity);
    }
    /**
     * @param \RoundingMode|\RoundingMode::* $mode
     */
    public static function bcround(string $num, int $precision = 0, $mode = \ClassLeak202605\RoundingMode::HalfAwayFromZero) : string
    {
        if (!\is_numeric($num)) {
    ...
    private static function roundIntegerPart(string $intPart, string $fracPart, int $sign, $mode) : string
    {
        ...
        switch ($mode) {
            case \ClassLeak202605\RoundingMode::TowardsZero:
                break;
            case \ClassLeak202605\RoundingMode::AwayFromZero:
                $shouldIncrease = \true;
                break;
            case \ClassLeak202605\RoundingMode::PositiveInfinity:
                $shouldIncrease = $sign > 0;
                break;
            case \ClassLeak202605\RoundingMode::NegativeInfinity:
                $shouldIncrease = $sign < 0;
                break;
            case \ClassLeak202605\RoundingMode::HalfAwayFromZero:
                $shouldIncrease = $isGreaterThanHalf || $isExactlyHalf;
                break;
            case \ClassLeak202605\RoundingMode::HalfTowardsZero:
                $shouldIncrease = $isGreaterThanHalf;
                break;
            case \ClassLeak202605\RoundingMode::HalfEven:
                ...
                break;
            case \ClassLeak202605\RoundingMode::HalfOdd:
                if ($isGreaterThanHalf) {
                    $shouldIncrease = \true;
